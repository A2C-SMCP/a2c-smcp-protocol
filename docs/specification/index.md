...
- [Computer Management Plane](computer-management.md) - 可信本地客户端通过 SDK/admin surface 管理 Computer desired state
...
- **MCP Server 开发者**: 无需任何改动，现有 MCP Server 可直接被 Computer 管理；MCP Server 还可通过暴露 `window://` 资源参与 [Desktop 桌面系统](desktop.md)，无需任何 SMCP 特定改动。结构化文档分发（PDF / Excel / PPT 等）见独立的 [DPE 协议](https://github.com/A2C-SMCP/dpe-protocol)
