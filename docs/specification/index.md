...
- **MCP Server 开发者**: 无需任何改动，现有 MCP Server 可直接被 Computer 管理；MCP Server 还可通过暴露 `window://` 资源参与 [Desktop 桌面系统](desktop.md)，或通过暴露 `dpe://` 资源参与 [DPE 文档协议](dpe.md)，同样无需任何 SMCP 特定改动
